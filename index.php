...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="section">
                <h2>Links:</h2>
                <a href="https://github.com/fabianwennink/IconCaptcha-Plugin-jQuery-PHP/" target="_blank" rel="noopener"><div class="btn">GitHub repository <small>Star the project on GitHub</small></small></div></a>
